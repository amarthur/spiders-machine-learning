...
class SpModel(pl.LightningModule):
    def __init__(self, num_classes, criterion: torch.nn.Module = None) -> None:
        ...
        self.train_acc = MulticlassAccuracy(self.num_classes, average="macro")
        self.train_acc_micro = MulticlassAccuracy(self.num_classes, average="micro")
        self.train_precision = MulticlassPrecision(self.num_classes, average="macro")
        self.train_recall = MulticlassRecall(self.num_classes, average="macro")
        self.train_f1 = MulticlassF1Score(self.num_classes, average="macro")
        self.train_conf_mat = MulticlassConfusionMatrix(self.num_classes)

        self.val_acc = MulticlassAccuracy(self.num_classes, average="macro")
        self.val_acc_micro = MulticlassAccuracy(self.num_classes, average="micro")
        self.val_precision = MulticlassPrecision(self.num_classes, average="macro")
        self.val_recall = MulticlassRecall(self.num_classes, average="macro")
        self.val_f1 = MulticlassF1Score(self.num_classes, average="macro")
        self.val_conf_mat = MulticlassConfusionMatrix(self.num_classes)

        self.train_metrics = {
            "Train Macro Accuracy": self.train_acc,
            "Train Micro Accuracy": self.train_acc_micro,
        ...
        self.val_metrics = {
            "Val Macro Accuracy": self.val_acc,
            "Val Micro Accuracy": self.val_acc_micro,
